...
````
 eksctl create cluster --name eks-01 --region ap-southeast-1 --version 1.35 --nodegroup-name linux-nodes --node-type c7i-flex.large --nodes 1
````
...
````
eksctl delete cluster --name eks-01 --region ap-southeast-1
````
